...
class FirebasePageFavouritePageWidget extends StatefulWidget {
  const FirebasePageFavouritePageWidget({Key? key}) : super(key: key);

  @override
  _FirebasePageFavouritePageWidgetState createState() =>
      _FirebasePageFavouritePageWidgetState();
}
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'hko8yr7m' /* FirebaseFavouriteFruiteList */,
          ),
            ...
            child: Padding(
              ...
              child: StreamBuilder<List<FruiteNamesRecord>>(
                stream: queryFruiteNamesRecord(
                  queryBuilder: (fruiteNamesRecord) =>
                      fruiteNamesRecord.where('is_favourite', isEqualTo: true),
                ),
