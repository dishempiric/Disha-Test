...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? FruiteNamesRecord.collection.doc(currentUser!.user!.uid)
    : null;

FruiteNamesRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : FruiteNamesRecord.getDocument(FruiteNamesRecord.collection.doc(uid))
              .handleError((_) {}),
    )
